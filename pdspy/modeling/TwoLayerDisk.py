...
class TwoLayerDisk:
    def __init__(self, mass=1.0e-3, rmin=0.1, rmax=300, plrho=2.37, h0=0.1, \
            ...
            delta=None, aturb=None, gaussian_gaps=False, amin=1., amax=1000.,\
            fmax=0.8, alpha_settle=1.0e-3, gamma_taper=None):
        self.mass = mass
        self.rmin = rmin
        self.rmax = rmax
        self.plrho = plrho
    ...
    def density(self, r, theta, phi):
        ...
        mass_frac = numpy.array([1. - self.fmax, self.fmax])
        
        ##### Get a list of the appropriate dust grain sizes.

        a = numpy.array([self.amin, self.amax])
