...
class Disk:
    ...
    def density(self, x1, x2, x3, coordsys="spherical", normalize=True):
        ...
        Sigma = self.surface_density(rr/au.cgs.value, normalize=normalize)
        h = self.scale_height(rr/au.cgs.value)
    ...
    def surface_density(self, r, normalize=True):
        ...
        Sigma[(r >= rout/au.cgs.value) ^ (r <= rin/au.cgs.value)] = 0e0
        ...
        if normalize:
            ...
            scale = mass / (2*numpy.pi*trapz(r_high*au.cgs.value*Sigma_high, r_high*au.cgs.value))
    ...
    def temperature_1d(self, r):
        ...
        T[(r >= rout/au.cgs.value) ^ (r <= rin/au.cgs.value)] = 0.0
